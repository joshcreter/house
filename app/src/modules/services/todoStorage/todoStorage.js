...
//angular.module('myApp').controller('TestCtrl', ['$scope', 'appTodoStorage', function($scope, appTodoStorage) {
//	var retVal =(appTodoStorage.test('my test val'));
//	console.log(retVal);
//}]);
//
//*/
...
//'use strict';
//
//angular.module('app').factory('appTodoStorage', [ function() {
//
